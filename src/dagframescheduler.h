...
/// Mezzanine::Threading::FrameScheduler::AddWorkUnitMain(iWorkUnit*) "FrameScheduler::AddWorkUnitMain(iWorkUnit*)".
...
/// Mezzanine::Threading::FrameScheduler::AddWorkUnitAffinity(iWorkUnit*) "FrameScheduler::AddWorkUnitAffinity(iWorkUnit*)".
/// @n @n
